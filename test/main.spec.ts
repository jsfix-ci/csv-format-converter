...
describe('Data parsing function', () => {
  ...
  it('Should parse given date string to outputCSVFormat date_format', () => {
    ...
    expect(Main.dataToOutputDateFormat('2020-01-21', 'Date Column',
                                       inputCSVFormat as CSVFormat,
                                       outputCSVFormat as CSVFormat)).toBe('21/01/2020');
  });
  ...
  it('Should throw an error, given date string is not valid', () => {
    ...
    expect(() => {
      Main.dataToOutputDateFormat('21/01/2020',
                                  'Date Column',
                                  inputCSVFormat as CSVFormat,
                                  outputCSVFormat as CSVFormat);
    }).toThrow();
  });
  ...
  it('Should parse given datetime string to outputCSVFormat datetime_format', () => {
    ...
    expect(Main.dataToOutputDatetimeFormat('2020-01-21T14:54:12.358+0000',
                                           'Datetime Column',
                                           inputCSVFormat as CSVFormat,
                                           outputCSVFormat as CSVFormat))
    .toBe('21/01/2020');
  ...
  it('Should throw an error, given datetime string is not valid', () => {
    ...
    expect(() => {
      Main.dataToOutputDatetimeFormat('21/01/2020',
                                      'Datetime Column',
                                      inputCSVFormat as CSVFormat,
                                      outputCSVFormat as CSVFormat);
    }).toThrow();
  ...
  it('Should parse given string to outputCSVFormat true_encoded_as', () => {
    ...
    expect(Main.dataToOutputBoolEncodedAs('true',
                                          'Boolean Column',
                                          inputCSVFormat as CSVFormat,
                                          outputCSVFormat as CSVFormat))
    .toBe('1');
  });
  // dataToOutputBoolEncodedAs transforms strings specified as boolean false
  // values to outputCSVFormat false_encoded_as
  it('Should parse given string to outputCSVFormat false_encoded_as', () => {
    ...
    expect(Main.dataToOutputBoolEncodedAs('false',
                                          'Boolean Column',
                                          inputCSVFormat as CSVFormat,
                                          outputCSVFormat as CSVFormat))
    .toBe('0');
  ...
  it('Should throw an error, given string is not equal to inputCSVFormat true_encoded_as or false_encoded_as', () => {
    ...
    expect(() => {
      Main.dataToOutputBoolEncodedAs('1',
                                     'Boolean Column',
                                     inputCSVFormat as CSVFormat,
                                     outputCSVFormat as CSVFormat);
    }).toThrow();
